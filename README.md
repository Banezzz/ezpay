...
<p align="center">
  <img src="wiki/img/usdtlogo.png" alt="EZPay Logo - Multi-chain Crypto Payment Gateway" width="120">
</p>
...
<p align="center">
  <a href="https://github.com/Banezzz/ezpay/stargazers"><img src="https://img.shields.io/github/stars/Banezzz/ezpay?style=flat-square&color=f5c542" alt="GitHub Stars 3000+"></a>
  ...
  <a href="https://github.com/Banezzz/ezpay/releases"><img src="https://img.shields.io/github/v/release/Banezzz/ezpay?style=flat-square&color=green" alt="Latest Release"></a>
</p>
...
| 教程 | 说明 |
|------|------|
| [Docker 部署](https://ezpay.infrix.org/guide/installation/docker) | 推荐方式，一键启动 |
| [宝塔面板部署](https://ezpay.infrix.org/guide/installation/aapanel) | 适合宝塔用户 |
| [手动部署](https://ezpay.infrix.org/guide/installation/manual.html) | 完全手动控制 |
| [开发者 API 文档](https://ezpay.infrix.org/zh/guide/integration/ezpay.html) | 接口集成指南 |
...
![EZPay 支付流程图](wiki/img/implementation_principle.jpg)
...
| 渠道 | 链接 |
|------|------|
| 📢 **EZPay 频道** | [https://t.me/ezpay](https://t.me/ezpay) |
| 💬 **EZPay 交流群** | [https://t.me/ezpay_group](https://t.me/ezpay_group) |
| 📚 **官方文档站** | [https://ezpay.infrix.org](https://ezpay.infrix.org) |

---

## Star History

<a href="https://www.star-history.com/?type=date&repos=banezzz%2Fezpay">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=banezzz/ezpay&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=banezzz/ezpay&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=banezzz/ezpay&type=date&legend=top-left" />
 </picture>
</a>
...
<p align="center">
  <sub>
    ...
    EZPay · Easy Payment USDT · Open Source Payment Gateway · 多链收款
  </sub>
</p>
